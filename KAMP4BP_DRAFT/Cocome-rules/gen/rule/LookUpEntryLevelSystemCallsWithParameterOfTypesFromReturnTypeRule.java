...
public class LookUpEntryLevelSystemCallsWithParameterOfTypesFromReturnTypeRule implements IDuplicateAwareRule {
  @Override
  ...
  public static final Set<CausingEntityMapping<EntryLevelSystemCall, EObject>> lookupEntryLevelSystemCallfromDataType(final CausingEntityMapping<DataType, EObject> dataTypeMapping, final AbstractArchitectureVersion<?> version) {
    ...
    java.util.stream.Stream<CausingEntityMapping<org.palladiosimulator.pcm.usagemodel.EntryLevelSystemCall, EObject>> backmarkedEntryLevelSystemCall__2 = edu.kit.ipd.sdq.kamp.util.LookupUtil.lookupBackwardReference(version, org.palladiosimulator.pcm.usagemodel.EntryLevelSystemCall.class, "operationSignature__EntryLevelSystemCall", backmarkedOperationSignature__1, false).stream();
    
    return backmarkedEntryLevelSystemCall__2.collect(Collectors.toSet());
  }
  
  @Override
  public void apply(final AbstractArchitectureVersion<?> version, final ChangePropagationStepRegistry registry) {
    LookupUtil.lookup(version, DataType.class, LookUpEntryLevelSystemCallsWithParameterOfTypesFromReturnTypeRule::lookupEntryLevelSystemCallfromDataType)
    	.forEach((result) -> {
